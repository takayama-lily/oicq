...
class AndroidClient extends Client {
    ...
    async sendTempMessage(group_id, user_id, message, auto_escape = false) {
        try {
    ...
    async setGroupKick(group_id, user_id, reject_add_request = false) {
        this.write(outgoing.buildGroupKickRequestPacket(546742060, 646702491, reject_add_request, this));
        return common.buildApiRet(1);
    }
    async setGroupBan(group_id, user_id, duration = 600) {
        this.write(outgoing.buildGroupBanRequestPacket(546742060, 646702491, duration, this));
        return common.buildApiRet(1);
    }
