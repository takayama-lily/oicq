        ...
        switch (type) {
            ...
            case "customFace":
                ...
                if (type === "notOnlineImage") {
                    ...
                    // file = Buffer.alloc(16);
                    // file.fill(o.md5).writeInt32BE(o.fileId, 16);
...
function buildAtMessage(chain, qq) {
    if (qq === "all") {
        ...
        for (let v of message) {
            switch (v.type) {
                case "text":
                    ...
                    break;
                case "at":
                    buildAtMessage(chain, v.data.qq);
                    break;
                case "face":
