"use strict";
const {emit, uinAutoCheck, parseFriendRequestFlag, parseGroupRequestFlag} = require("./common");
const pb = require("./pb");
...
async function addFriend(group_id, user_id, comment = "") {
    ...
    const AF = jce.encodeStruct([
        this.uin,
        user_id, type?1:0, 1, 0, type?15:0, String(comment), 0, 1, null, 3004,
...
module.exports = {
    setStatus, setProfile, setSign, sendLike, addFriend, delFriend, friendAction, groupAction,
