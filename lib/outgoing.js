...
function buildFriendInfoRequestPacket(user_id, c) {
    const body = pb.encode("OIDBSSOPkg", {
        command: 1867,
        serviceType: 0,
        result: 0,
        bodybuffer: Buffer.from([0x8,0x8b,0xe5,0xf2,0xa0,0x3,0x50,0x11,0x50,0x12]),
        clientVersion: "android 8.2.7"
    });
    return commonUNI(c, "OidbSvc.0x74b", body);
}
...
module.exports = {
    ...
    buildGroupMemberInfoRequestPacket, buildStrangerInfoRequestPacket, buildFriendInfoRequestPacket,
