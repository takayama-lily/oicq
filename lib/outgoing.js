...
const CMD = {
    ...
    DISCUSS_MSG:    "OnlinePush.PbPushDisMsg", //recv(event)
    ...
    GROUP_MNG:      "ProfileService.GroupMngReq", //send,recv
...
module.exports = {
    ...
    buildHeartbeatRequestPacket, buildClientRegisterRequestPacket, buildChangeStatusRequestPacket,
    buildConfPushResponsePacket, buildOnlinePushResponsePacket,

    // message
    buildGetMessageRequestPacket, buildDeleteMessageRequestPacket, commonMessage,
    ...
    buildGroupInfoRequestPacket, buildGroupMemberInfoRequestPacket, buildStrangerInfoRequestPacket,

    // request
    buildNewGroupActionRequestPacket, buildNewFriendActionRequestPacket, buildNewFriendRequestPacket, buildNewGroupRequestPacket,

    // group operation
    buildEditSpecialTitleRequestPacket, buildGroupSettingRequestPacket, buildSetGroupAdminRequestPacket, buildGroupLeaveRequestPacket,
