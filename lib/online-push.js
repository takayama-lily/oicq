...
const push528 = {
    0x8A: function(buf, time) {
        ...
        this.em("notice.friend.recall", {
            user_id, message_id: chat.genGroupMessageId(user_id, data[3], data[6]&0xffffffff), time
        });
    },
...
const push732 = {
    ...
    0x11: function(group_id, buf, time) {
        ...
        const user_id = msg[6];
        const message_id = chat.genGroupMessageId(group_id, msg[1], msg[3]);
...
function onOnlinePushTrans(blob, seq) {
    ...
    handleOnlinePush.call(this, push[11]&0xffffffff, seq);
...
function onC2CMsgSync(blob, seq) {
    const o = _pb.decode("PushMessagePacket", blob);
...
function onGroupMsg(blob, seq) {
    const o = _pb.decode("PushMessagePacket", blob);
    if (!this.sync_finished) return;
    chat.onGroupMsg.call(this, o.message.head, o.message.body);
}
...
function onDiscussMsg(blob, seq) {
    ...
    handleOnlinePush.call(this, o.svrip, seq);
    if (!this.sync_finished) return;
    chat.onDiscussMsg.call(this, o.message.head, o.message.body);
}
