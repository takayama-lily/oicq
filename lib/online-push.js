...
function buildOnlinePushResponsePacket(svrip, seq, rubbish, c) {
    ...
    return commonUNI(c, "OnlinePush.RespPush", body);
}

function onOnlinePush(blob, c, seq) {
    ...
    for (let v of list) {
        ...
        if (v[2] === 528) {
            ...
            if (data[0] === 0x8A || data[0] === 0x8B) {
                ...
                common.emit(c, "notice.friend.recall", {
                ...
                common.emit(c, "notice.friend.increase", {
                    user_id, nickname
                });
            } else if (data[0] === 0xD4) {
            ...
            if (data[0] === 0x3B) {
                ...
                const group_id = toInt(data.groupCode);
                common.emit(c, "notice.group.setting", {
                    group_id, user_id: -1,
            ...
            if (data[0] === 0x27) {
                ...
                if (data.type === 5) {
                    ...
                    common.emit(c, "notice.friend.decrease", {
                        user_id, nickname
                    });
                }
                if (data.type === 20) {
                    ...
                    if (user_id === c.uin)
                        ...
                        const e = {user_id};
                        e[key] = value;
                        common.emit(c, "notice.friend.profile", e);
                    }
                }
                if (data.type === 60) {
                    ...
                    if (user_id === c.uin)
                        ...
                        common.emit(c, "notice.friend.profile", {
            ...
            if (v[6][4] === 0x0C) {
                ...
                common.emit(c, "notice.group.ban", {
            ...
            if (v[6][4] === 0x11) {
                ...
                common.emit(c, "notice.group.recall", {
            ...
            if (v[6][4] === 0x14) {
                ...
                if (data.optGeneralGrayTip) {
                    ...
                    if (!user_id)
                        user_id = c.uin;
                    common.emit(c, "notice.group.poke", {
            ...
            if (o[4] === 0x06 && o[5] === 1) {
                ...
                if (sub.entry && sub.entry.text) {
                    ...
                    if (str.includes("获得群主授予的")) {
                        ...
                        common.emit(c, "notice.group.title", {
                            group_id, user_id,
                            nickname, title
                        });
                        continue;
            ...
            if (field && enable !== undefined) {
                ...
                e[field] = enable;
                common.emit(c, "notice.group.setting", e);
            }
        }
    }
    c.write(buildOnlinePushResponsePacket(parent[3], seq, rubbish, c));
}
async function onOnlinePushTrans(blob, c, seq) {
    const o = pb.decode("TransMsgInfo", blob);
    c.write(buildOnlinePushResponsePacket(o.svrIp, seq, [], c));
    ...
    if (o.msgType === 44) {
        if (buf[5] === 0 || buf[5] === 1) {
            ...
            common.emit(c, "notice.group.admin", {
            ...
            common.emit(c, "notice.group.transfer", {
    ...
    if (o.msgType === 34) {
        ...
        common.emit(c, "notice.group.decrease", {
...
module.exports = {
    onOnlinePush, onOnlinePushTrans, buildOnlinePushResponsePacket
};
