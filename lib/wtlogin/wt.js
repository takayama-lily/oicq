...
async function passwordLogin() {
    ...
    const body = new Writer()
        ...
        .read();
    const sso = commonSSO(this, "wtlogin.login", commonOICQ(this, body));
...
async function heartbeat() {
    this.nextSeq();
    const sso = commonSSO(this, "Heartbeat.Alive", BUF0);
...
async function register() {
    ...
    const sso = commonSSO(this, "StatSvc.register", body, this.sign_info.tgt);
