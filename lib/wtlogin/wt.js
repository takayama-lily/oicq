...
async function passwordLogin() {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到passwordLogin响应包或发生严重错误。");
    }
}
...
async function captchaLogin(captcha) {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到captchaLogin响应包或发生严重错误。");
    }
}
...
async function sliderLogin(ticket) {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到sliderLogin响应包或发生严重错误。");
    }
}
...
async function deviceLogin() {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到deviceLogin响应包或发生严重错误。");
    }
}
...
async function sendSMS() {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到sendSMSCode响应包或发生严重错误。");
    }
}
...
async function smsLogin(code) {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到submitSMSCode响应包或发生严重错误。");
    }
}
...
async function tokenLogin(d2) {
    ...
    try {
        ...
        this.logger.debug(e);
        return this.emit("internal.network", "未收到tokenLogin响应包或发生严重错误。");
    }
}
...
module.exports = {
    passwordLogin, captchaLogin, sliderLogin, heartbeat, register, exchangeEMP, sendSMS, smsLogin
};
