...
function build0x0BPacket(cmd, body, seq = 0) {
    ...
    body = new Writer()
        ...
        .writeBytes(tea.encrypt(sso, this.sig.d2key))
        .read();
    return new Writer().writeWithLength(body).read();
}
...
async function passwordLogin() {
    ...
    const body = new Writer()
        ...
        .writeBytes(t(0x525))
        .read();
    const pkt = build0x0APacket.call(this, "wtlogin.login", commonOICQ.call(this, body), 2);
    try {
...
module.exports = {
    passwordLogin, captchaLogin, heartbeat, register, build0x0BPacket
};
