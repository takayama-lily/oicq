...
async function passwordLogin() {
    ...
    try {
        ...
        return this.emit("internal.wt.failed", "未收到passwordLogin响应包。");
    }
...
async function captchaLogin(captcha) {
    ...
    try {
        ...
        return this.emit("internal.wt.failed", "未收到captchaLogin响应包。");
    }
    decodeLoginResponse.call(this, blob);
}
...
async function deviceLogin() {
    ...
    try {
        ...
        return this.emit("internal.wt.failed", "未收到deviceLogin响应包。");
    }
    decodeLoginResponse.call(this, blob);
}
