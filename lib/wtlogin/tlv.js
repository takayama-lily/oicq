...
function packTlv(tag, ...args) {
    ...
    stream.unshift(len);
    const series = Buffer.allocUnsafe(2);
...
const tlv_map = {
    ...
    0x100: function(emp = 0) {
        return new Writer()
            ...
            .writeU32(this.appid)
            .writeU32(emp?2:this.sub_appid)
            .writeU32(0) // app client ver
            .writeU32(this.sigmap);// sigmap
    },
    0x104: function() {
        return new Writer().writeBytes(this.t104);
    },
    0x106: function(emp = 0) {
    ...
    0x142: function() {
        return new Writer()
            .writeU16(0)
            .writeTlv(this.apkid.slice(0, 32));
    },
    0x144: function() {
        const body = new Writer()
            .writeU16(5) // tlv cnt
    ...
    0x147: function() {
        return new Writer()
            .writeU32(this.appid)
            .writeTlv(this.apkver.slice(0, 5))
            .writeTlv(this.apksign);
    },
    0x154: function() {
    ...
    0x177: function() {
        return new Writer()
            .writeU8(0x01)
            .writeU32(this.buildtime)
            .writeTlv(this.sdkver);
    },
    0x187: function() {
