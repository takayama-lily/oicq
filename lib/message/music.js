...
async function getMiGuSongInfo(id) {
    ...
    let getJumpUrl = await fetch(`https://app.c.nf.migu.cn/MIGUM2.0/v1.0/content/shareInfo.do?contentId=${rsp.copyrightId}&contentName=${rsp.songName}&resourceType=2&targetUserName=${rsp.singer}`)
