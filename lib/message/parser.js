            ...
            case 53: //commonElem
                if (o[1] === 3) {
                    ...
                    if (o[2][1]) { //customFace
                        ...
                        msg.data.url = `http://gchat.qpic.cn/gchatpic_new/0/${from}-${o[2][1][7]}-${o[2][1][13].raw.toString("hex").toUpperCase()}/0?term=2`;
                    }
                    else if (o[2][2]) { //notOnlineImage
                        msg.data.file = o[2][2][7].raw.toString("hex") + (o[2][2][2]?o[2][2][2]:"");
