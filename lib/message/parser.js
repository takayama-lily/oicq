        ...
        switch (type) {
            ...
            case 4: //notOnlineImage
                ...
                if (o[15])
                    ...
                    msg.data.url = `http://c2cpicdw.qpic.cn/offpic_new/0/${o[10].raw}/0?term=2]`;
                break;
            case 8: //customFace
                // console.log(Object.getPrototypeOf(o))
                msg.type = "image";
                ...
                if (o[16])
                    ...
                    msg.data.url = `http://gchat.qpic.cn/gchatpic_new/0/0-0-${o[13].raw.toString("hex").toUpperCase()}/0?term=2`;
                break;
            case 53:
                if (o[1] === 3) {
                    msg.type = "flash";
