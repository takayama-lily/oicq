    ...
    for (let v of elems) {
        ...
        switch (type) {
            ...
            case 4: //notOnlineImage
                msg.type = "image";
                msg.data.file = buildImageFileParam(o[7].raw, o[2], o[9], o[8], o[5]);
                if (o[15])
            ...
            case 8: //customFace
                msg.type = "image";
                msg.data.file = buildImageFileParam(o[13].raw, o[25], o[22], o[23], o[20]);
                if (o[16])
                    msg.data.url = "http://gchat.qpic.cn" + o[16].raw;
                else
                    msg.data.url = `http://gchat.qpic.cn/gchatpic_new/0/${from}-0-${o[13].raw.toString("hex").toUpperCase()}/0?term=2`;
                break;
            case 53: //commonElem
                if (o[1] === 3) {
                    msg.type = "flash";
                    if (o[2][1]) { //customFace
                        o = o[2][1];
                        msg.data.file = buildImageFileParam(o[13].raw, o[25], o[22], o[23], o[20]);
                        msg.data.url = `http://gchat.qpic.cn/gchatpic_new/0/${from}-0-${o[2][1][13].raw.toString("hex").toUpperCase()}/0?term=2`;
                    }
                    else if (o[2][2]) { //notOnlineImage
                        o = o[2][2];
                        msg.data.file = buildImageFileParam(o[7].raw, o[2], o[9], o[8], o[5]);
                        msg.data.url = `http://c2cpicdw.qpic.cn/offpic_new/${from}/${o[2][2][10].raw}/0?term=2`;
                    }
                    ignore_text = true;
                } else if (o[1] === 33) {
                    msg.type = "face";
