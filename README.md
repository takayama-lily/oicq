...
| system.offline          | 下线                              |
| request.friend.add      | 好友申请                          |
| request.friend.single   | 对方已将你加为单向好友，可回添对方 |
| request.friend          | 好友事件                          |
...
| message.private.friend  | 从好友                            |
| message.private.group   | 从群临时会话                      |
| message.private.other   | 从其他途径                        |
| message.private.self    | 从我的设备                        |
...
| sync.message            | 私聊消息同步                      |
| sync.read               | 已读同步                          |
| sync.read.private       | 私聊已读同步                      |
| sync.read.group         | 群聊已读同步                      |
| internal.sso            | 监听所有收到的包                  |
